...
DataPretreatFlow::DataPretreatFlow(ros::NodeHandle& nh, std::string cloud_topic) {
    ...
    pos_vel_pub_ptr_ = std::make_shared<PosVelPublisher>(nh, "/synced_pos_vel", "/n_frame", "/b_frame", 100);
    gnss_pub_ptr_ = std::make_shared<OdometryPublisher>(nh, "/synced_gnss", "/n_frame", "/n_frame", 100);
...
bool DataPretreatFlow::ValidData() {
    ...
    //std::cout << "current cloud data : " << current_cloud_data_.time << std::endl;
    //std::cout << "cloud data buff front : " << cloud_data_buff_.front().time << std::endl;
    ...
    //std::cout << "cloud data buff front after pop : " << cloud_data_buff_.front().time << std::endl;
